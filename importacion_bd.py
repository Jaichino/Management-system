...
def importar_datos():
    ...
    #df_detalleventas = pd.read_csv(r"C:\Users\juani\OneDrive\Desktop\detalleventas.csv")
    #df_productos = pd.read_csv(r"C:\Users\juani\OneDrive\Desktop\productos.csv")
