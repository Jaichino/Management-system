...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblDineroCalle.setText(QCoreApplication.translate("MainWindow", u"Deuda total: $", None))
        self.btnEliminarUltimaCC.setText(QCoreApplication.translate("MainWindow", u"Eliminar \u00faltimo registro", None))
        self.lblDeudaTotalCC.setText(QCoreApplication.translate("MainWindow", u"Deuda cliente: $ x", None))
